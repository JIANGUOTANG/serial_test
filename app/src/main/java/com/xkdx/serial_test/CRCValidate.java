...
public class CRCValidate {
	...
	public static void main(String[] args) throws Exception {
        String code = "19 03 16 02 26 00 DC 00 05 01 5E 00 03 00 47 00 57 00 00 00 01 00 00 00 8F";
		byte[] tx_buff = HexStrConvertUtil.hexStringToByte(code);
		...
		System.out.println(Arrays.toString(b_result));
	}
}